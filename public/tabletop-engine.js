// Generated by scripts/build-client.mjs. Edit src/room-engine.mjs and src/holdem-rules.mjs.
(function(root) {
"use strict";
...
class HoldemError extends Error {
...
function compareHoldemRanks(left, right) {
...
function createHoldemState(players, options = {}) {
...
function holdemLegalActions(state, playerId) {
...
function planHoldem(original, command, context) {
...
function remapHoldem(state, cardMap, playerMap = new Map()) {
...
function projectHoldem(state, viewerId) {
  if (!state) return null;
...
function validateHoldemState(source, { players, cards, decks, objects }) {
...
return Object.freeze({ HoldemError, createHoldemPack, compareHoldemRanks, evaluateHoldem, holdemPots, createHoldemState, holdemLegalActions, planHoldem, remapHoldem, projectHoldem, validateHoldemState });
})();
root.ParlorHoldem = holdemRules;
const { HoldemError, createHoldemPack, createHoldemState, planHoldem, remapHoldem, projectHoldem, validateHoldemState } = holdemRules;
...
root.ParlorEngine = Object.freeze({ TABLE_GEOMETRY, RoomError, privateZoneForSeat, privateCardPosition, requestPrivateCards, cancelPrivateCardRequest, publicStackForCard, validateGamePack, validatePortablePack, createRoom, replaceRoomPack, joinRoom, playerForSession, setPlayerConnection, RESOURCE_CATALOG, addRoomPack, applyCommand, exportRoomScene, validateRoomScene, restoreRoomScene, exportRoomGame, validateRoomGame, restoreRoomGame, exportRoomCheckpoint, roomFromCheckpoint, projectRoom, roomSummary });
})(globalThis);
