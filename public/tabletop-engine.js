...
root.ParlorEngine = Object.freeze({ TABLE_GEOMETRY, RoomError, privateZoneForSeat, privateCardPosition, requestPrivateCards, cancelPrivateCardRequest, cardSource, isExposedDeckCard, publicStackForCard, validateGamePack, validatePortablePack, createRoom, replaceRoomPack, joinRoom, playerForSession, setPlayerConnection, RESOURCE_CATALOG, addRoomPack, applyCommand, exportRoomScene, validateRoomScene, restoreRoomScene, exportRoomGame, validateRoomGame, restoreRoomGame, exportRoomCheckpoint, roomFromCheckpoint, projectRoom, roomSummary });
})(globalThis);
