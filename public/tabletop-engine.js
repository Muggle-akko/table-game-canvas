...
const QUICK_PHRASE_LIFETIME = 5000;
const QUICK_PHRASE_COOLDOWN = 800;
...
function quickPhraseSignal(room, playerId, message, now = Date.now()) {
...
root.ParlorEngine = Object.freeze({ BOARD_LAYOUTS, BOARD_RESOURCES, BOARD_GAME_SETS, TABLE_GEOMETRY, QUICK_PHRASES, QUICK_PHRASE_LIFETIME, QUICK_PHRASE_COOLDOWN, RoomError, privateZoneForSeat, privateCardPosition, quickPhraseSignal, requestPrivateCards, cancelPrivateCardRequest, cardSource, isExposedDeckCard, publicStackForCard, tokenStackIndex, tokenStackMembers, validateGamePack, validatePortablePack, createRoom, replaceRoomPack, joinRoom, playerForSession, setPlayerConnection, RESOURCE_CATALOG, addRoomPack, tableSelectionResources, tableResourceBounds, tableSelectionDelta, cardDealPlan, applyCommand, exportRoomScene, validateRoomScene, restoreRoomScene, exportRoomGame, validateRoomGame, restoreRoomGame, exportRoomCheckpoint, roomFromCheckpoint, projectRoom, roomSummary });
})(globalThis);
